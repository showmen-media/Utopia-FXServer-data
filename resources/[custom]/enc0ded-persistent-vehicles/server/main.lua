...
RegisterCommand('epv_register', function(source, args)
  local vehicle = GetVehiclePedIsIn(GetPlayerPed(-1))
  if DoesEntityExist(vehicle) then
    TriggerEvent('persistent-vehicles/register-vehicle', vehicle)
    TriggerClientEvent('chatMessage', source, '', {0,255,0}, 'Success!')
  else
    TriggerClientEvent('chatMessage', source, '', {255,0,0}, 'Fail!')
  end
end)
