...
admins = {
    'steam:110000103cf2f5b',
    'steam:110000104d4f320',
    'steam:110000104ee9bb7',
    'steam:1100001062eae97',
    'steam:11000010d047dab',
    'steam:11000014065b41c'
}
...
RegisterServerEvent('vSync:updateTime')
AddEventHandler('vSync:updateTime', function(_baseTime, _timeOffset, _freezeTime)
    TriggerClientEvent('vSync:updateTime', -1, _baseTime, _timeOffset, _freezeTime)
end)

RegisterServerEvent('vSync:updateWeather')
AddEventHandler('vSync:updateWeather', function(_CurrentWeather, _blackout)
    TriggerClientEvent('vSync:updateWeather', -1, _CurrentWeather, _blackout)
end)

RegisterServerEvent('vSync:requestSync')
AddEventHandler('vSync:requestSync', function()
    TriggerEvent('vSync:updateWeather', CurrentWeather, blackout)
    TriggerEvent('vSync:updateTime', baseTime, timeOffset, freezeTime)
end)
